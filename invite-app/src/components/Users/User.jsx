const User = ({avatar, first_name, last_name, id, email, invitedUsers, inviteHandler}) => (
    <li key={id}>
        <div>
        ...
        <img className="action" src={`/assets/${invitedUsers.includes(id) ? 'minus' : 'plus'}.svg`}
             alt="Action" onClick={() => inviteHandler(id)}/>
    </li>
);
export default User;
